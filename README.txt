...
As a functional example, this module includes the Values CCK module, which allows the
admin to assign a reusable value set to a CCK field, instead of using the
